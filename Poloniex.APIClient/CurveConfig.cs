...
namespace Poloniex.APIClient
{
    ...
    {
        public static CurveConfig Drop(int periodLengthMinutes = 30, decimal minCurvePct = 0.08m)
        {
        ...
        public static CurveConfig Raise(int periodLengthMinutes = 30, decimal minCurvePct = -0.08m)
        {
            var periodLength = TimeSpan.FromMinutes(periodLengthMinutes);
